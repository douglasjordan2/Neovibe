return {
  {
    ...
    opts = {
      ...
      dashboard = {
        preset = {
          header = table.concat({
            " _______  _______________________   ____.________________________",
            " \\      \\ \\_   _____/\\_____  \\   \\ /   /|   \\______   \\_   _____/",
            " /   |   \\ |    __)_  /   |   \\   Y   / |   ||    |  _/|    __)_ ",
            "/    |    \\|        \\/    |    \\     /  |   ||    |   \\|        \\",
            "\\____|__  /_______  /\\_______  /\\___/   |___||______  /_______  /",
            "        \\/        \\/         \\/                     \\/        \\/ ",
            "",
            "              AI-native Neovim. Vibe coding.",
          }, "\n"),
          keys = {
            ...
            { icon = "󰋠 ", key = "h", desc = "Health Check", action = ":checkhealth neovibe" },
            { icon = " ", key = "?", desc = "Cheatsheet", action = ":NeovibeCheatsheet" },
